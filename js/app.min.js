...
prontoWeather.displayWeather(a.query.results.channel);else $("#loading.animated").one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend",function(){$(".error-msg").addClass("show");prontoWeather.displayModal("#loading","hide");$("#loading.animated").one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend",function(){prontoWeather.displayModal("#location-settings","show")})})})["catch"](function(a){prontoWeather.displayModal("#location-settings",
