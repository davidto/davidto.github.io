...
d=$("<p>").addClass("temp-all").append(d,a);$(".weather-forecast").prepend(b.append(c,e,d))});$("#wrapper-weather").show();prontoWeather.displayModal("#location-settings","hide");prontoWeather.displayModal("#loading","hide")},getWeather:function(){$.ajax({url:'https://query.yahooapis.com/v1/public/yql?q=select * from weather.forecast where woeid in (select woeid from geo.places(1) where text="'+prontoWeather.location+'") and u="c"',method:"GET",dataType:"json",data:{format:"json"}}).then(function(a){if(a.query.results)$(".error-msg").removeClass("show"),
prontoWeather.displayWeather(a.query.results.channel);else $("#loading.animated").one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend",function(){prontoWeather.displayModal("#loading","hide");prontoWeather.displayModal("#location-settings","show");$(".error-msg").addClass("show")})})["catch"](function(a){prontoWeather.displayModal("#location-settings","show");prontoWeather.displayModal("#loading","hide")})},init:function(){prontoWeather.getLocation();$(".widget-settings").on("click",
function(a){a.preventDefault();prontoWeather.displayModal("#location-settings","show")});$("#getLocation").on("click",function(a){a.preventDefault();prontoWeather.displayModal("#loading","show");prontoWeather.displayModal("#location-settings","hide");prontoWeather.getLocation()});$("#inputAddress").on("submit",function(a){a.preventDefault();prontoWeather.location=$("#inputPlace").val();prontoWeather.displayModal("#location-settings","hide");prontoWeather.displayModal("#loading","show");prontoWeather.getWeather();
$("#inputPlace").val("")})}};$(function(){prontoWeather.init()});